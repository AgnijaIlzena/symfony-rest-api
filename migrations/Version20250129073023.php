 ...
 */
final class Version20250129073023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE investment ADD mandataire VARCHAR(255) NOT NULL, ADD ppi VARCHAR(255) NOT NULL, ADD lycee VARCHAR(255) NOT NULL, ADD notification_du_marche DATETIME DEFAULT NULL, ADD codeuai VARCHAR(255) NOT NULL, ADD longitude DOUBLE PRECISION NOT NULL, ADD etat_d_avancement VARCHAR(255) NOT NULL, ADD montant_des_ap_votes_en_meu DOUBLE PRECISION NOT NULL, ADD cao_attribution DATETIME DEFAULT NULL, ADD latitude DOUBLE PRECISION NOT NULL, ADD maitrise_d_oeuvre VARCHAR(255) NOT NULL, ADD mode_de_devolution VARCHAR(255) NOT NULL, ADD annee_d_individualisation INT NOT NULL, ADD enveloppe_prev_en_meu DOUBLE PRECISION NOT NULL, CHANGE annee annee_de_livraison DATETIME DEFAULT NULL');
    }
